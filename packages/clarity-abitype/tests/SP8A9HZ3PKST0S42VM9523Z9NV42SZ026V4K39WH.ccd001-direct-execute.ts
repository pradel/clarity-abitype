export const ccd001DirectExecuteAbi = {
  functions: [
    {
      name: "callback",
      access: "public",
    ...
    },
    {
      ...
      access: "public",
      args: [{ name: "signals", type: "uint128" }],
      outputs: { type: { response: { ok: "bool", error: "uint128" } } },
    },
    {
  ...
  variables: [
    ...
    { name: "signalsRequired", type: "uint128", access: "variable" },
    { name: "sunsetBlock", type: "uint128", access: "variable" },
  ],
  maps: [
    {
    ...
    { name: "Approvers", key: "principal", value: "bool" },
    { name: "SignalCount", key: "principal", value: "uint128" },
  ],
  fungible_tokens: [],
  non_fungible_tokens: [],
  epoch: "Epoch2_05",
